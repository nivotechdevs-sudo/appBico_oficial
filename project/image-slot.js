...
(() => {
  ...
  const stylesheet =
    ...
    ':host([compact]) .empty svg,:host([compact]) .empty .sub{display:none}' +
    ':host([compact]) .empty .cap{font-size:11px;max-width:96%}' +
  ...
  class ImageSlot extends HTMLElement {
    ...
    constructor() {
      ...
      root.innerHTML =
        ...
        '    <div class="cap"></div>' +
        '    <div class="sub">ou <u>escolher do celular</u></div></div>' +
        '  <div class="attr-error" part="attribution-error">' + warnIcon +
        '    <div class="cap">Esta foto precisa de crédito</div></div>' +
    ...
    _render() {
      ...
      this._cap.textContent = this.getAttribute('placeholder') || 'Arraste uma imagem';
