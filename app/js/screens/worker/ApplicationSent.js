    ...
    h('div', { class: 'flex flex-col items-center text-center gap-5 px-6 pt-10 pb-8 lg:max-w-app lg:mx-auto' },
      ...
      Card({ tone: 'sunken', padding: 'md', className: 'w-full' },
        h('div', { class: 'flex items-center justify-between gap-3' },
          h('div', { class: 'flex flex-col gap-0.5 min-w-0' }, h('span', { class: 'font-semibold text-concrete-900' }, job.role), h('span', { class: 'text-sm text-concrete-500' }, `${company.name} · ${job.date}`)),
